AFJOB_WEB A Job Recruitment Web Application built with ASP.NET MVC About AFJOB_WEB is a job recruitment web application that allows recruiters to post job listings and job seekers to apply for jobs. 
